...
class GoogleMapPlotter(object):
    ...
    def _process_kwargs(self, kwargs):
        ...
        settings["edge_width"] = kwargs.get("edge_width", None) or \
                                 ...
                                 1.0
        settings["edge_text"] = kwargs.get("edge_text", None) or \
                                 kwargs.get("et", None) or \
                                 ""
        settings["edge_delta_width"] = kwargs.get("edge_delta_width", None) or \
                                 kwargs.get("edw", None) or \
                                 2
...
function zoomToObject(obj){
    ...
    def write_polyline(self, f, path, settings):
        ...
        strokeDeltaWeight = settings.get('edge_delta_width')
        strokeText = settings.get('edge_text')
...
function polylineMouseOver(polyline, event) {
    if (selectedPath) {
        ...
        selectedPath.setOptions({strokeWeight: selectedPath.strokeWeight / ''' + str(strokeDeltaWeight) + '''});
    }
